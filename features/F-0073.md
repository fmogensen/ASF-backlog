...
- 2026-09-22 18:21 ingest: stage plan-approved → building 1/5 (spec on origin/main; plan on origin/main; 1/5 tasks Closed)
- 2026-09-23 06:43 ingest: stage building 1/5 → building 2/5 (spec on origin/main; plan on origin/main; 2/5 tasks Closed)
- 2026-09-23 08:14 ingest: stage building 2/5 → building 3/5 (spec on origin/main; plan on origin/main; 3/5 tasks Closed)
- 2026-09-23 12:57 ingest: stage building 3/5 → building 4/5 (spec on origin/main; plan on origin/main; 4/5 tasks Closed)
- 2026-09-23 17:27 ingest: state Active → Closed (spec on origin/main; plan on origin/main; 5/5 tasks Closed)
- 2026-09-23 17:27 ingest: stage building 4/5 → landed (spec on origin/main; plan on origin/main; 5/5 tasks Closed)
...
## Children
- [T-0031](../tasks/T-0031.md) The shape rules — `asf/groom/shape.py` — Closed
- [T-0032](../tasks/T-0032.md) The record keeps the reading — `write_new_item`, file-bugs' shape line, `asf check`'s size rules — Closed
- [T-0033](../tasks/T-0033.md) Intake reads the shape — `process_inbox`, the groom line, the intake directory — Closed
- [T-0034](../tasks/T-0034.md) `asf inbox` — one untyped card into the record's intake directory — Closed
- [T-0035](../tasks/T-0035.md) `asf new` mints only what a spec or plan cuts — Stories with acceptance, Tasks with writes — Closed
