...
- [T-0047](../tasks/T-0047.md) `asf.workers.observe` — every session on the machine, whose it is, which account — New
- [T-0048](../tasks/T-0048.md) pool load counts every product's sessions and foreign ones, once each; the wave's running check is per product — New
