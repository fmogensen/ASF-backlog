...
## Children
- [T-0036](../tasks/T-0036.md) The nine fields, `forbidden_patterns()`, and `python3 -m asf.conventions` — New
- [T-0037](../tasks/T-0037.md) The workflow names fold into the object, and the example yaml says so — New
- [T-0038](../tasks/T-0038.md) The evidence provider asks for nothing the product did not declare — New
...
- [T-0041](../tasks/T-0041.md) The sample product differs on every kind of convention, and CI reads the result — New
