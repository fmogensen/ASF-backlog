...
- [T-0101](../tasks/T-0101.md) reconciliation — the marker, one question, three answers that write evidence — Active
- [T-0102](../tasks/T-0102.md) a reconciled item closes through the ordinary rules — New
- [T-0103](../tasks/T-0103.md) nothing re-emitted — the cap over every launching kind — New
