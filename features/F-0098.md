...
- 2026-09-24 18:32 ingest: stage plan-approved → building 0/1 (rule: documented; spec on origin/main; plan on origin/main; 0/1 tasks Closed)
- 2026-09-26 07:37 ingest: state Active → Closed (rule: children-closed; spec on origin/main; plan on origin/main; 1/1 tasks Closed)
- 2026-09-26 07:37 ingest: stage building 0/1 → landed (rule: children-closed; spec on origin/main; plan on origin/main; 1/1 tasks Closed)

## Children
- [T-0087](../tasks/T-0087.md) the classifier — five states, the evidence ladder, and `derive` re-expressed over it — Closed
- [T-0088](../tasks/T-0088.md) the seat frees the moment the process is gone — Closed
- [T-0089](../tasks/T-0089.md) the three views say what happened — Closed
- [T-0090](../tasks/T-0090.md) health writes the classifier's reason, stall and harvest ask it, and nothing else derives state — Closed
