...
removed: the same defect as B-0105 (a flow-style map loads as a string); one fix closes both. (groom 2026-09-24)
# ---- machine ----
schema_version: 1
state: New
...
- 2026-09-24 groom: removed → the same defect as B-0105 (a flow-style map loads as a string); one fix closes both. (groom 2026-09-24) (adjudicator, groom-2026-09-24)
