...
removed: the same defect as B-0117 (the Prod row reads a key the product schema has not got). (groom 2026-09-24)
# ---- machine ----
schema_version: 1
state: New
...
- 2026-09-24 groom: removed → the same defect as B-0117 (the Prod row reads a key the product schema has not got). (groom 2026-09-24) (adjudicator, groom-2026-09-24)
