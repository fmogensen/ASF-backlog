...
- [F-0151](../features/F-0151.md) A branch whose remote is an older rebase of the same work strands the session's commits: settle two-rebase divergence in code — Closed
- [F-0161](../features/F-0161.md) Wave launch costs ~55 s per session: 5 launches make most of a 242 s wave — New
